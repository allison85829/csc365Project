...
INSERT INTO Books (title, author, category, availability) VALUES ("The Littlest Christmas Tree", "R. A. Herman", "Children's Books", 0);
...
INSERT INTO Books (title, author, category, availability) VALUES ("Exploring Calvin and Hobbes: An Exhibition Catalogue", "Bill Watterson", "Comics & Graphic Novels", 0);
...
INSERT INTO Books (title, author, category, availability) VALUES ("Harry Potter and the Sorcerer's Stone", "J.K. Rowling", "Science Fiction & Fantasy", 0);
...
INSERT INTO Books (title, author, category, availability) VALUES ("The Lightning Thief", "Rick Riordan", "Science Fiction & Fantasy", 0);
INSERT INTO Books (title, author, category, availability) VALUES ("The Lightning Thief", "Rick Riordan", "Science Fiction & Fantasy", 1);
...
INSERT INTO Books (title, author, category, availability) VALUES ("Saving the World and Other Extreme Sports", "James Patterson", "Science Fiction & Fantasy", 0);
INSERT INTO Books (title, author, category, availability) VALUES ("School's Out Forever", "James Patterson", "Science Fiction & Fantasy", 0);
...
INSERT INTO CheckoutHistories (book_id, student_id, checkout_date, due_date, return_date, times_renewed) VALUES (30, 10, "2019-05-25", "2019-06-01", NULL, 0);
INSERT INTO CheckoutHistories (book_id, student_id, checkout_date, due_date, return_date, times_renewed) VALUES (31, 10, "2019-05-25", "2019-06-01", NULL, 0);
...
UPDATE Students SET books_checked_out = 4 WHERE student_id = 4;
UPDATE Students SET books_checked_out = 3 WHERE student_id = 10;
UPDATE Students SET books_checked_out = 1 WHERE student_id = 14;